...
const products = [
  {
    ...
    about: '',
    imageSrc: '../assets/images/products/bars_img.jpg',
  },
  {
    id: 2,
    name: 'Переносні Бруси',
    about: '',
    imageSrc: '../assets/images/products/low_bars_img.jpg',
  },
  {
    id: 3,
    name: 'Стійка для елементів',
    about: '',
    imageSrc: '../assets/images/products/stand_img.jpg',
  },
  {
    id: 4,
    name: 'Паралетси',
    about: '',
    imageSrc: '../assets/images/products/paralets_img.jpg',
  },
  {
    id: 5,
    name: 'Гумові і латексні петлі',
    about: '',
    imageSrc: '../assets/images/products/rubber_img.jpg',
  },
  {
    id: 6,
    name: 'Обважнювачі',
    about: '',
    imageSrc: '../assets/images/products/gainers_img.jpg',
  },
  {
    id: 7,
    name: 'Шкіряні накладки',
    about: '',
    imageSrc: '../assets/images/products/linings_img.jpg',
  },
  {
    id: 8,
    name: 'Кистьові бинти',
    about: '',
    imageSrc: '../assets/images/products/bandages_img.jpg',
  },
  {
    id: 9,
    name: 'Магнезія',
    about: '',
    imageSrc: '../assets/images/products/magnesium_img.jpg',
  },
]
</script>

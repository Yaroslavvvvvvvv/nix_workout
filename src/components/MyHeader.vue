...
<template>
  <header class="sticky top-0 bg-gray-950 z-50">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8 animate-fade-down animate-duration-1000"
      ...
      <PopoverGroup class="hidden lg:flex lg:gap-x-12">
        ...
        <a href="#" class="text-lg font-bold leading-6 text-gray-300 hover:text-white">Каталог</a>
        <a href="#" class="text-lg font-bold leading-6 text-gray-300 hover:text-white">Галерея</a>
    ...
    <Dialog as="div" class="lg:hidden" @close="mobileMenuOpen = false" :open="mobileMenuOpen">
      ...
      <DialogPanel
          ...
          class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-gray-100/75 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
        ...
        <div class="mt-6 flow-root">
          <div class="-my-6 divide-y divide-gray-500/10">
            <div class="space-y-2 py-6">
              ...
              <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-bold leading-7 text-gray-900 hover:bg-gray-100/50">Каталог</a>
              <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-bold leading-7 text-gray-900 hover:bg-gray-100/50">Галерея</a>

    ...
    <div class="flex flex-col justify-between lg:flex-row gap-16 lg:items-center">
      ...
      <div class="flex flex-col gap-4 lg:w-2/4">
        ...
        <ul>
          ...
          <li class="mt-2 text-base xl:text-lg lg:text-lg md:text-lg sm:text-lg leading-7 text-gray-500">
            - зручні в транспортуванні (вага 2 кг)
          </li>
          <li class="mt-2 text-base xl:text-lg lg:text-lg md:text-lg sm:text-lg leading-7 text-gray-500">
...
export default {
  data() {
    return {
      imagesMini: {
        ...
        img2: "/images/wooden_details/six_wooden.jpg",
        img3: "/images/wooden_details/second_wooden.jpg",},
      productData: {},
      firstFirebaseImage: "",
      cart: [],
    };
  ...
  async created() {
    try {
      const productDoc = doc(db, 'wooden_paralets', 'RPdKnCfDC1PpxvtfPBtm');
